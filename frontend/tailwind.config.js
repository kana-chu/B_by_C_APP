...
export default {
    ...
    theme: {
        ...
        colors: {
            ...
            /* disabled（light） */
            "ui-btn-disabled": "#D6D1C6",
            "ui-btn-disabled-text": "#8E8A82",

            /* dark */
            "ui-btn-dark": "#8D8170",
            "ui-btn-hover-dark": "#7C7365",
            "ui-btn-text-dark": "#EDECEC",

            /* disabled（dark） */
            "ui-btn-disabled-dark": "#6A655A",
            "ui-btn-disabled-text-dark": "#C4C2BC",
        ...
        function ({ addBase, theme }) {
            addBase({
                ":root": {
                    ...
                    "--ui-btn-disabled": theme("colors.ui-btn-disabled"),
                    "--ui-btn-disabled-text": theme("colors.ui-btn-disabled-text"),
                ...
                ".dark": {
                    ...
                    "--ui-btn-disabled": theme("colors.ui-btn-disabled-dark"),
                    "--ui-btn-disabled-text": theme("colors.ui-btn-disabled-text-dark"),
